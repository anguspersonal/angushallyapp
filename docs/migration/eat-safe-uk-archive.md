...
- **If the product returns:** Add colocated handlers under `web/src/app/api/hygiene/` and `src/lib/hygiene/`, backed by Supabase, and update `docs/migration/server-to-next-mapping.md`.
