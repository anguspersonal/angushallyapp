...
function buildConfig() {
  ...
  const parsed = {
    ...
    STRAVA_CLIENT_ID: coerceString('STRAVA_CLIENT_ID', raw.STRAVA_CLIENT_ID, { required: !isTestEnv, defaultValue: testDefault('STRAVA_CLIENT_ID') }, errors),
    STRAVA_CLIENT_SECRET: coerceString('STRAVA_CLIENT_SECRET', raw.STRAVA_CLIENT_SECRET, { required: !isTestEnv, defaultValue: testDefault('STRAVA_CLIENT_SECRET') }, errors),
