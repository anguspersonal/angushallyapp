        ...
        >
          ...
          >
            <Image
              ...
              fallbackSrc="/20250418_3BY2_Default_Image_Placeholder.png"
          ...
          >
            <Title
              ...
              style={{
                textAlign: isSmallScreen ? 'center' : 'left',
                fontSize: isSmallScreen ? rem(22) : undefined
              }}
            >
          ...
          <Accordion variant="separated" transitionDuration={200}>
            <Accordion.Item value="operations">
              ...
              <Accordion.Panel>
                ...
                I've turned around floundering public sector projects <Anchor component={Link} href="/blog/vej-pandemic-rollout"><strong>(see: VEJ rollout)</strong></Anchor>, scaled startup operations from scratch <Anchor component={Link} href="/blog/future-factory-digital-pivot"><strong>(see: Teamvine)</strong></Anchor>, and led agile teams through high-pressure, time-sensitive delivery.
              </Accordion.Panel>
            </Accordion.Item>
            ...
            <Accordion.Item value="proposition">
              ...
              <Accordion.Panel>
                ...
                I've done this with early-stage founders <Anchor component={Link} href="/blog/retail-journey-insight"><strong>(see: Proposition Reset case)</strong></Anchor> and in pitching for grant funding <Anchor component={Link} href="/blog/future-factory-digital-pivot"><strong>(see: Future Factory / Teamvine)</strong></Anchor>. I translate complexity into narrative clarity — fast.
              </Accordion.Panel>
            </Accordion.Item>
            ...
            <Accordion.Item value="gtm">
              ...
              <Accordion.Panel>
                ...
                I've helped teams get to market while still building <Anchor component={Link} href="/blog/future-factory-digital-pivot"><strong>(see: Teamvine launch)</strong></Anchor> and helped large-scale clients unlock sales from dormant segments <Anchor component={Link} href="/blog/commercial-usage-insight"><strong>(see: Telecom Insight)</strong></Anchor>.
              </Accordion.Panel>
            </Accordion.Item>
            ...
            <Accordion.Item value="fundraising">
              ...
              <Accordion.Panel>
                ...
                I've helped secure public funding <Anchor component={Link} href="/blog/future-factory-digital-pivot"><strong>(Innovate UK grant – Teamvine)</strong></Anchor> and regularly coach founders through positioning for pre-seed and seed. I bring strategic thinking plus delivery support so your raise gets you real momentum.
              </Accordion.Panel>
            </Accordion.Item>
            ...
            <Accordion.Item value="data">
              ...
              <Accordion.Panel>
                ...
                I've built data valuation frameworks for national agencies <Anchor component={Link} href="/blog/dvsa-data-valuation"><strong>(DVSA)</strong></Anchor>, commercial models unlocking millions <Anchor component={Link} href="/blog/commercial-usage-insight"><strong>(Telecoms)</strong></Anchor>, and internal systems to track performance in startups <Anchor component={Link} href="/blog/future-factory-digital-pivot"><strong>(Teamvine)</strong></Anchor>.
              </Accordion.Panel>
            </Accordion.Item>
          </Accordion>
        </Box>
